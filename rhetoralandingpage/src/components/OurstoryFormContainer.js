...
import OurStoryForm from './forms/OurStoryPageForm';

const OurStoryFormContainer = ({ title }) => {
	return (
		<div className="flex justify-center md:absolute w-full z-20 top-[-150%]">
			<div
...
export default OurStoryFormContainer;
