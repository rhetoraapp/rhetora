            ...
            <div className="d-flex flex-column mt-5 transform justify-center pb-4 md:mt-2 md:scale-90 ">
              ...
              <div className="flex flex-col md:mt-4 md:h-[55vh]">
                  ...
                  <div className="order-3 flex basis-1/4 flex-col rounded-[17px] text-center">
                    <Fade duration={1000} delay={isMobile ? 0 : second * 3}>
                      <div className="my-1.5 flex w-full flex-1 flex-col rounded-[17px] bg-graylight p-3 text-center">
                        <img className="my-auto mb-4 scale-90 px-4 pt-3 md:scale-100" src={require("../assets/companies.svg").default} />
                        <Heading className="my-auto w-full text-4xl" background="linear-gradient(93.79deg, #A974F1 18.63%, #75A9FF 89.95%)">
                          <span className="text-5xl">AUTO-PILOT</span>
                          <br />
                          Sales Assistant
                        </Heading>
                      </div>
                ...
                <div className="flex basis-1/4 flex-col md:flex-row ">
                  <Fade className="flex-1" duration={1000} delay={isMobile ? 0 : second * 4}>
                  ...
                  <Fade className="flex-1" duration={1000} delay={isMobile ? 0 : second * 6}>
                    <div className="my-1.5 flex flex-1 flex-col rounded-[17px] bg-graylight p-3 text-center md:mr-3">
                  ...
                  <Fade className="flex-1" duration={1000} delay={isMobile ? 0 : second}>
                    <div className="my-1.5 flex min-h-[180px] flex-1 rounded-[17px] bg-graylight p-3 text-center">
                      <Heading className="my-auto w-full  text-4xl" background="linear-gradient(93.79deg, #A974F1 18.63%, #75A9FF 89.95%)">
                        <span className="text-5xl md:text-6xl">UNLIMITED</span> <br />
                        Mock Cold Calls
                      </Heading>
                    </div>
                  </Fade>
